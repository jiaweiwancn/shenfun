...
rounded value `0.00005`.  Do not continue from job 3206.  The refined spin-up
and sampling paths include `dt5em5`, so they cannot silently reuse that failed
pilot's files.
...
bash prepare_sampling_checkpoint.sh \
  /share/home/dkyzdsys_wanjiawei/shenfun_runs/re395/production_mkm_Re395_N192_256_192_dt5em5_spinup/MKM_Re395_N192_256_192_dt5em5_spinup.chk.h5
```
